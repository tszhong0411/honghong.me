...
export const GET = async (_: Request, props: OGRouteProps) => {
  try {
    ...
    const [fontInterSemiBold, fontRobotoCondensedBold] = await Promise.all([
      interSemiBold,
      RobotoCondensedBold
    ])
    ...
    return new ImageResponse(
      (
        <div
          tw='w-full h-full flex flex-col px-14 py-12 text-white justify-between items-center'
          style={{
        ...
        >
          <div
            ...
            style={{ fontFamily: 'Inter', color: 'hsl(0 0% 90%)' }}
          >
            {date}
          </div>
          <div
