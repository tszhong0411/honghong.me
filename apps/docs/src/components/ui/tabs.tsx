...
const TabsTrigger = (props: TabsTriggerProps) => {
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        'text-foreground dark:text-muted-foreground inline-flex h-[calc(100%-1px)] flex-1 items-center justify-center gap-1.5 whitespace-nowrap rounded-md border border-transparent px-2 py-1 text-sm font-medium transition-[color,box-shadow]',
