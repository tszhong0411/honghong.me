...
modifiedTime: '2022-08-22T03:57:00Z'
summary: Using Next.js to build a blog is very easy!
image: 'how-to-build-a-blog-with-nextjs-and-mdx/cover.en.png'
---
...
<Alert icon='💡' title='Tips' color='yellow' radius='md'>
  The following is written in `lib\mdx.js`
</Alert>
...
<Alert icon='💡' title='Tips' color='yellow' radius='md'>
  The following is written in `lib\formatDate.js`
</Alert>
...
<Alert icon='💡' title='Tips' color='yellow' radius='md'>
  The following is written in `pages\index.js`
</Alert>
...
<Alert icon='💡' title='Tips' color='yellow' radius='md'>
  The following is written in `pages\[slug].js`
</Alert>
