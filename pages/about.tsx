      ...
      <PageContainer title="About">
        <div className="prose max-w-none py-6 dark:prose-dark">
          {language === 'zh-TW' && (
            <>
              <p>
                ...
                <Link href="https://www.youtube.com/c/TheNetNinja">The Net Ninja</Link> 並從中學習
                Web 開發，我擁有超過 1 年的網頁開發經驗 :)
              </p>
              <p>
          ...
          {language === 'en' && (
            <>
              <p>
                I am a student. In order to challenge new things I started learning web development
                in December 2020. I found{' '}
                <Link href="https://www.youtube.com/c/TheNetNinja">The Net Ninja</Link> on Youtube
                and learn Web development from it. I have over 1 year of web development experience
                :)
              </p>
              <p>
                I like to use <Link href="https://nextjs.org/">Next.js</Link> framework,{' '}
                <Link href="https://tailwindcss.com/">Tailwind</Link> css framework and{' '}
                <Link href="https://github.com/">Github</Link> to save the source code and{' '}
