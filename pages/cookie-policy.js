            ...
            <div className="divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <div className="prose max-w-full py-12 dark:prose-dark">
                    <div>
                        ...
                        <p>
                            Session Cookie 允許網站或服務將您在瀏覽器 session
                            期間的行動連接起來。我們使用 session cookies
                            來啟用網站或服務的某些功能，以更好地了解您與網站或服務的互動情況，並監測用戶的總體使用情況和網站上的網絡流量路由。與
                            persistent cookies
                            不同的是，當您從網站或服務中退出並關閉瀏覽器時，session
                            cookies 將從您的設備中刪除。
                        </p>
                        ...
                        <p>
                            由於 cookies
                            不存儲在我們的系統中，而是存儲在您的本地設備，我們無法檢索或刪除
                            cookies。但是，您可以按照以下指南刪除設備上現有的
                            cookies。
                        </p>
                        <ul>
                            <li>
